...
export default function Home() {
  const a_style =
    "w-[150px] my-2 h-[50px] px-[25px] py-[10px] text-center transition rounded-2xl border-[#373584] xl:hover:border-white duration-300 border-2 xl:hover:text-white xl:hover:cursor-pointer xl:text-[#373584] xl:hover:text-white";
  const a_dummy = "w-[150px] h-[50px] px-[25px] py-[10px] text-center";
  ReactGA.initialize("G-5XQQLB2M6F");
  ReactGA.send({ hitType: "pageview", page: "/talents", title: "kanna" });
  return (
        ...
        >
          ...
          <div className="flex flex-wrap xl:flex-none inherit justify-center mt-[70px] xl:mt-0 xl:top-[177px]">
            ...
            <div className=" xl:block  mt-16 xl:ml-20">
              <div className=" text-[2.25rem] xl:text-7xl text-[#373584] xl:hover:cursor-default">
                아이리 칸나
              </div>
              <div className="text-[#373584] mt-4 xl:hover:cursor-default">
                Airi Kanna
              </div>
              <div className="text-[#373584] mt-4 xl:hover:cursor-default font-sunf">
                용궁의 황녀
              </div>
              <div className="text-[#373584] mt-4 xl:hover:cursor-default font-sunf">
                155cm | 1700세 | 12월 2일
              ...
              <div className="text-center mx-4 xl:text-left mt-8 xl:ml-14 text-[#373584] font-bold text-lg font-sunf xl:hover:cursor-default">
                용궁의 부흥을 위해 지구를 찾아왔다.
                <br />
                용궁의 황녀로서 지식과 시야를 넓히기 위해 용궁 생활을 뒤로하고
                지구에 오게되었다.
                <br />
                {/* 이는 바로 유메퍼센트에 “명예 100%”로 관측이 되었고, 합류하게 된다.<br /> */}
                시청자들의 앞에 선 그녀에게선 지도자로서의 카리스마를 볼 수 있을
                것이다.
                <br />
              </div>
              <div className="mx-10 xl:mx-0 xl:w-[500px] min-h-[250px] flex flex-wrap justify-between mt-20 xl:ml-16 text-center mb-10">
                <a
                  ...
                  href="https://chzzk.naver.com/f722959d1b8e651bd56209b343932c01"
                  target="blank"
                >
                  Chzzk
                </a>
                <a
                  ...
                  href="https://www.youtube.com/@airikannach"
                  target="blank"
                >
                  Youtube
                </a>
                <a
                  className={`${a_style} text-[#FF0000] xl:hover:bg-[#FF0000]`}
                  href="https://www.youtube.com/@airikanna"
                  target="blank"
                >
                  Music
                </a>
                <a
                  className={`${a_style} text-[#FF0000] xl:hover:bg-[#FF0000]`}
                  href="https://www.youtube.com/channel/UC6CXZ-3mspWOXdxfpceumLw"
                  target="blank"
                >
                  Replay
                </a>
                <a
                  ...
                  href="https://soundcloud.com/airikanna"
                  target="blank"
                >
                  SoundCloud
                </a>
                ...
                <a
                  ...
                  href="https://cafe.naver.com/ArticleList.nhn?search.clubid=29424353&search.menuid=131&search.boardtype=L"
                  target="blank"
                >
                  Naver Cafe
                </a>
