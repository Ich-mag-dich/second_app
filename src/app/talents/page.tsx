...
export default function Home() {
  ...
  const divWidth =
    " my-[30px] w-[400px] h-[625px] sm:w-[400px] sm:h-[625px] md:w-[400px] md:h-[625px] lg:w-[400px] lg:h-[625px] xl:w-[400px] xl:h-[625px] 2xl:w-[400px] 2xl:h-[625px]";
  const imgWidth =
    "w-[308px] sm:w-[308px] md:w-[308px] lg:w-[308px] xl:w-[308px] 2xl:w-[308px]";
  return (
    <main>
      <div className="flex justify-center">
        <div className="text-center mx-auto my-[2.25rem] justify-center items-center flex flex-wrap">
          <Link href="/talents/airi_kanna">
            ...
            >
              <div
                className={`flex justify-between items-center  w-[308px] absolute left-0 top-6 px-12`}
              >
              ...
              <div className="flex inherit justify-center items-center text-center mx-auto w-[310px] top-[77px]">
                <img
                  ...
                  src="/static/kanna3.jpg"
                ></img>
              </div>

              <p className="relative top-[80px] right-[40px] text-gray-300 ">
                https://twitter.com/atwomaru
              </p>
            </div>
          </Link>
