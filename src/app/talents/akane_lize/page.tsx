            ...
            <div className=" xl:block  mt-16 xl:ml-20">
              ...
              <div className="mx-10 xl:mx-0 xl:w-[500px] min-h-[150px] flex flex-wrap justify-between mt-20 xl:ml-16 text-center">
                ...
                <a
                  ...
                  href="https://youtube.com/@akanelize"
                  target="blank"
                >
                  Youtube
                </a>
                <a
                  className={`${a_style} text-[#FF0000] xl:hover:bg-[#FF0000]`}
                  href="https://www.youtube.com/@lizereplay"
                  target="blank"
                >
                  Replay
                </a>
                ...
                <a
                  ...
                  href="https://cafe.naver.com/ArticleList.nhn?search.clubid=29424353&search.menuid=151&search.boardtype=L"
                  target="blank"
                >
                  Naver Cafe
                </a>
