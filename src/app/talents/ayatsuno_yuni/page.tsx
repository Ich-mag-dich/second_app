...
export default function Home() {
  const a_style =
    "my-2 w-[150px] h-[50px] px-[25px] py-[10px] text-center transition rounded-2xl border-[#7C86DF] xl:hover:border-white duration-300 border-2 xl:hover:text-white xl:hover:cursor-pointer xl:text-[#7C86DF] xl:hover:text-white";
        ...
        >
          ...
          <div className="flex flex-wrap xl:flex-none inherit justify-center mt-[70px] xl:mt-0 xl:top-[177px]">
            ...
            <div className=" xl:block  mt-16 xl:ml-20">
              <div className=" text-[2.25rem] xl:text-7xl text-[#7C86DF] xl:hover:cursor-default">
                아야츠노 유니
              </div>
              <div className="text-[#7C86DF] mt-4 xl:hover:cursor-default">
                Ayatsuno Yuni
              </div>
              <div className="text-[#7C86DF] mt-4 xl:hover:cursor-default font-sunf">
                타락을 꿈꾸는 순수의 상징, 유니콘
              </div>
              ...
              <div className="text-center mx-4 xl:text-left mt-8 xl:ml-8 text-[#7C86DF] font-bold text-lg font-sunf xl:hover:cursor-default">
                다른 유니콘들이 멸망을 향해갈 때, 혼자 잠들어 있었던 유니는{" "}
                <br />
                시간이 지나 홀로 눈을 떴다.
                <br />
                {/* 는 “순수 100%”로서 유메퍼센트에 관측된다.<br />
                                이후 보호를 위해 유메퍼센트에 합류하게 된다.<br /> */}
                타락할지, 순수함을 전해갈 지는 유니의 선택에 맡겨졌다.
                <br />
              </div>
              <div className="mx-10 xl:mx-0 xl:w-[500px] min-h-[150px] flex flex-wrap justify-between mt-20 xl:ml-16 text-center mb-10">
                ...
                <a
                  ...
                  href="https://www.youtube.com/@ayatsunoyuni"
                  target="blank"
                >
                  Youtube
                </a>
                <a
                  className={`${a_style} text-[#FF0000] xl:hover:bg-[#FF0000]`}
                  href="https://www.youtube.com/@Yunireplay"
                  target="blank"
                >
                  Replay
                </a>
                ...
                <a
                  ...
                  href="https://cafe.naver.com/tteokbokk1?iframe_url=/ArticleList.nhn%3Fsearch.clubid=29424353%26search.menuid=134%26search.boardtype=L"
                  target="blank"
                >
                  Naver Cafe
                </a>
