        ...
        >
          ...
          <div className="flex flex-wrap xl:flex-none inherit justify-center mt-[70px] xl:mt-0 xl:top-[177px]">
            ...
            <div className=" xl:block  mt-16 xl:ml-20">
              ...
              >
                임무를 받고 지구로 내려와 자신의 행성의 고양이 동료들을 찾는
                도중 <br />
                유일한 수단인 탐지기를 잃어버려 헤매다
                <br />
                스텔라이브를 발견하게 된다.
                <br />
              </div>
              <div className="mx-10 xl:mx-0 xl:w-[500px] min-h-[150px] flex flex-wrap justify-between mt-20 xl:ml-16 text-center mb-10">
                <a
                  ...
                  href="https://chzzk.naver.com/4515b179f86b67b4981e16190817c580"
                  target="blank"
                >
                  Chzzk
                </a>
                <a
                  ...
                  href="https://youtube.com/@neneko_mashiro"
                  target="blank"
                >
                  Youtube
                </a>
                <a
                  className={`${a_style} text-[#FF0000] xl:hover:bg-[#FF0000]`}
                  href="https://www.youtube.com/@mashiroreplay"
                  target="blank"
                >
                  Replay
                </a>
                ...
                <a
                  ...
                  href="https://cafe.naver.com/ArticleList.nhn?search.clubid=29424353&search.menuid=150&search.boardtype=L"
                  target="blank"
                >
                  Naver Cafe
                </a>
