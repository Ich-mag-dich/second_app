          ...
          <div className="flex flex-wrap xl:flex-none inherit justify-center mt-[70px] xl:mt-0 xl:top-[177px]">
            ...
            <div className=" xl:block  mt-16 xl:ml-20">
              ...
              >
                ...
                여행 중 우연히 알게 된 하늘 도시의 보물을
                <br />
                훔쳐서 도망가는 도중에 길을 잃어버리게 되고
                <br />
                하늘 도시의 영역에서 떨어지게 된다.
                <br />
              </div>
              <div className="mx-10 xl:mx-0 xl:w-[500px] min-h-[150px] flex flex-wrap justify-between mt-20 xl:ml-16 text-center mb-10">
                <a
                  ...
                  href="https://chzzk.naver.com/a6c4ddb09cdb160478996007bff35296"
                  target="blank"
                >
                  Chzzk
                </a>
                <a
                  ...
                  href="https://youtube.com/@arahashitabi"
                  target="blank"
                >
                  Youtube
                </a>
                <a
                  className={`${a_style} text-[#FF0000] xl:hover:bg-[#FF0000]`}
                  href="https://www.youtube.com/@tabireplay"
                  target="blank"
                >
                  Replay
                </a>
                ...
                <a
                  ...
                  href="https://cafe.naver.com/ArticleList.nhn?search.clubid=29424353&search.menuid=152&search.boardtype=L"
                  target="blank"
                >
                  Naver Cafe
                </a>
