...
export default function Home() {
  ...
  const content =
    " I'm Pastel은 버츄얼 아이돌 그룹 '스텔라이브'의 팬 사이트 입니다. ";
  ...
  return (
    <main className="h-full xl:hover:cursor-default">
      <img
        src="/static/stellive.svg"
        alt="logo"
        className="  xl:ml-20 xl:mt-[-110px] w-[300px] xl:w-[500px] h-auto absolute z-[-1]"
      ></img>
        ...
        <div className=" block py-5 xl:py-20 mt-[140px] xl:mt-[200px] xl-[10px] xl:ml-[130px]">
          <figure className="xl:w-[1000px] pl-[1.5rem]  xl:pl-[2.25rem]">
            ...
            <blockquote cite="https://pastel.im/">
              <p
                className={`${contentClassName2} min-w-[300px] xl:w-[520px] 2.5xl:w-[920px] qw font-sunf`}
              >
                {content}
              </p>
            </blockquote>
